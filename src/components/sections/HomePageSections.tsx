      ...
      <section className="relative overflow-hidden py-24 sm:py-28">
        {specialties.map((spec) => (
          <Image
            ...
            sizes="100vw"
            aria-hidden="true"
            className={`pointer-events-none object-cover object-center transition-all duration-500 ${
              activeSpecialtyHref === spec.href
                  ...
                  {specialties.map((spec) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span
                            className={`flex h-16 w-16 shrink-0 items-center justify-center rounded-full border text-sm font-semibold tracking-[0.16em] transition-colors ${
                              active
                        ...
                        <div
                          className={`grid px-4 pb-4 transition-all duration-300 sm:px-5 sm:pb-5 ${
                            active
        ...
        <div className="oa-marquee-wrap mt-2" aria-hidden="true">
          <div className="oa-marquee-track gap-4 py-2 pr-4">
            {marqueeCards.map((brand, i) => (
              <div
                key={`${brand.name}-${i}`}
                className="relative flex h-[92px] w-[210px] shrink-0 items-center justify-center overflow-hidden rounded-[1.65rem] border border-[#0D1F3C]/10 bg-white px-6 text-center"
              >
                <div
                  aria-hidden="true"
                ...
                />
                <span className="relative text-lg font-semibold tracking-[-0.03em] text-[#0D1F3C]">
                  {brand.name}
                </span>
              </div>
            ))}
